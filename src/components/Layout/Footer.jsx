...
const Footer = () => {
  const socialLinks = [
    ...
    { icon: <FaTwitter />, link: "www.x.com" },
    { icon: <FaInstagram />, link: "www.instagram.com" },
    { icon: <FaLinkedinIn />, link: "www.linkedin/in.com" },
  ];
  ...
  return (
    <footer className="bg-gray-900 text-brand-white py-12 px-6 md:px-16">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex space-x-4">
            {socialLinks.map((n, idx) => (
              <a
                key={idx}
                href={n.link}
                className="hover:bg-brand-hover rounded-full transition"
              >
                {n.icon}{" "}
              </a>
            ))}
        ...
        <div className="flex flex-col space-y-2">
          ...
          {quickLinks.map((sl, idx) => (
            <a
              key={idx}
              href={sl.link}
              className="text-gray-400 hover:text-brand-hover rounded-full transition"
            >
              {sl.title}
            </a>
          ))}
        ...
        <div className="flex flex-col space-y-2">
          ...
          <p className="text-gray-400">123 Artisan Street, Lagos, Nigeria</p>
