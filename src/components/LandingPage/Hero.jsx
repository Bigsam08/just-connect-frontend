...
const Hero = () => {
  return (
    <section
      className="relative min-h-[95vh] flex flex-col items-center justify-center text-center text-brand-white"
      style={{
    ...
    >
      ...
      {/* Search Bar Overlap */}
      <div className="absolute -bottom-18 md:-bottom-10 w-full px-6 z-20">
